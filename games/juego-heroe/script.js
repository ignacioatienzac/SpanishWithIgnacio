...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function inicializarJuego() {
        ...
        const castleTopMargin = Math.max(48, Math.round(canvas.height * 0.22));
        const availableCastleHeight = Math.max(160, nivelSuelo - castleTopMargin);
        const castleHeight = Math.min(availableCastleHeight, 260);
