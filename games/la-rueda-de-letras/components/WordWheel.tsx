    ...
    return (
        <div className="relative flex flex-col items-center">
            ...
            <button
                ...
                className="word-wheel-shuffle mt-6 md:mt-4 w-12 h-12 md:w-11 md:h-11 flex items-center justify-center"
                title="Shuffle"
            >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 md:h-6 md:w-6 text-[#c0392b]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
